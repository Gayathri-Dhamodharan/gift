  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white/10 m-5 overflow-hidden">
      ...
      <div className="relative">
        ...
        {/* Letter Content */}
        {open && (
          <div className="max-w-2xl bg-white p-10 rounded-3xl shadow-2xl text-center animate-fadeIn gap-5 flex flex-col items-center justify-center">
...
At that time, we never imagined
that the way we stood together in those simple photos
was a glimpse of the day we would stand together on our wedding stage 👰🤵💍.
<br /><br />
...
<p className="flex flex-col text-end  mt-10">
  <i>with all my love,</i>
  <br />
 <b>Your Chlm 💖</b> 
</p>

<button className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded-full mt-4 flex justify-center items-center "   onClick={() => navigate("/surprise")}
>
  See My Surprise 💕
      </button>
